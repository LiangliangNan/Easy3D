...
namespace easy3d {
    ...
    inline int version_major() { return EASY3D_MAJOR_VERSION; }
    /// returns the major version number of Easy3D
    inline int version_minor() { return EASY3D_MINOR_VERSION; }
    /// returns the minor version number of Easy3D
    inline int version_patch() { return EASY3D_PATCH_VERSION; }
