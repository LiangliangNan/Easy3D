...
#ifndef EASY3D_RENDERER_MODEL_H
#define EASY3D_RENDERER_MODEL_H
...
namespace easy3d {
    ...
    /**
     * Model is the base class for renderable 3D models, e.g., Surface, PointSet, ComMap.
    ...
    class Mesh : public Model, public SurfaceMesh {
    public:
        void property_stats(std::ostream &output) const {
            return SurfaceMesh::property_stats(output);
        }
//        using SurfaceMesh::points;
//        using SurfaceMesh::bounding_box;
    };


    class Cloud : public Model, public PointCloud  {
    public:
        void property_stats(std::ostream &output) const {
            return PointCloud::property_stats(output);
        }
//        using PointCloud::points;
//        using PointCloud::bounding_box;
    };


    class Map : public Model, public Graph {
    public:
        void property_stats(std::ostream &output) const {
            return Graph::property_stats(output);
        }
//        using Graph::points;
//        using Graph::bounding_box;
    };

}

#endif  // EASY3D_RENDERER_MODEL_H
