...
namespace easy3d {
    ...
    namespace opengl
    {
         ...
         */
        void prepare_camera(std::vector<vec3>& points, float width, float fov, float hw_ratio = 0.6f);
        /**
         ...
         * \param hw_ratio The aspect ratio of the base quad defined as height/width (default 0.6).
         */
        void prepare_camera(std::vector<vec3>& points, std::vector<unsigned int>& indices, float width, float fov, float hw_ratio = 0.6f);
    }
