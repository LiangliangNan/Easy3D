...
//        explicit Texture(const QImage& image, MipMapGeneration genMipMaps = GenerateMipMaps);
        ~Texture();
        ...
        static unsigned int boundTextureId(BindingTarget target);
        static unsigned int boundTextureId(unsigned int unit, BindingTarget target);
        ...
        Texture *createTextureView(Target target,
...
//        void setData(const QImage& image, MipMapGeneration genMipMaps = GenerateMipMaps);
        ...
        void setBorderColor(const vec3& color);
        void setBorderColor(float r, float g, float b, float a);
        void setBorderColor(int r, int g, int b, int a);
        void setBorderColor(unsigned int r, unsigned int g, unsigned int b, unsigned int a);

        vec3 borderColor() const;
