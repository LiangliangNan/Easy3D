...
namespace easy3d {
    ...
    public:
         ...
         * @param y The y-coordinate of the starting position, relative to the bottom edge of the content area.
...
/// \sa ofRectangle
        ...
        Rect draw_multi_line(const std::string &text, float x, float y, float font_size, ofAlignHorz align = OF_ALIGN_HORZ_LEFT, float width = 0, int fontID = 0,
                             const vec3 &font_color = vec3(0, 0, 0)) const;
#endif
    ...
    private:
        ...
        Rect get_bbox( const std::string& text, float size, float x, float y, ofAlignHorz align = OF_ALIGN_HORZ_LEFT, float width = 0 ) const;
#endif
