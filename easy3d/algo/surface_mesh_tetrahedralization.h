...
namespace easy3d {
    ...
    public:
        ...
        /**
         * \brief Sets if Steiner points are allowed on the boundary edges and faces of the input surface.
         * \param x Boolean value to allow or disallow Steiner points on boundary. Default is true.
        ...
        /**
         * \brief Sets the maximum allowable radius-edge ratio.
         * \param x The maximum radius-edge ratio. Default value is 2.0.
         * \details The value controls how new points can be added to improve the mesh quality.
        ...
        /**
         * \brief Sets the minimum allowable dihedral angle.
         * \param x The minimum dihedral angle. Default value is 0.
         * \details The value controls how new points can be added to improve the mesh quality.
         *      More complicated constraints can be set by using set_command_line(). See the "-q" switch in tetgen manual.
         *      http://wias-berlin.de/software/tetgen/1.5/doc/manual/manual005.html#cmd-q
        ...
        /**
         * \brief Sets the maximum volume constraint on all tetrahedra.
         * \param x The maximum volume constraint. Default value is -1 (no max volume constraint).
        ...
        /**
         * \brief If enabled, assigns an additional attribute (an integer number) to each tetrahedron that identifies to what
         *      facet-bounded region it belongs.
         * \param x Boolean value to enable or disable region tagging.
         * \details In the output mesh, all tetrahedra in the same region will get a corresponding non-zero attribute.
         */
        void set_tag_regions(bool x) { tag_regions_ = x; }

        /**
         * \brief If specified, overrides all other options.
         * \param x The command line string to override other options.
         */
        void set_command_line(const std::string &x) { command_line_ = x; }

        /**
         * \brief Performs tetrahedralization on the input mesh.
         * \param mesh The surface mesh to be tetrahedralized.
         * \return A pointer to the generated polyhedral mesh.
         */
