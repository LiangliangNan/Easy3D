/* Liangliang: this code seems to have bugs (see below for an example. When you switch the
*              order of the two triangles, it returns different results).
* -------------------------------- begin example -------------------------------------
* float u1[] = { 0.002152010099962354f, 0.05587499961256981f, 0.02351249940693378f };
* float u2[] = { 0.002138929907232523f, 0.05552500113844872f, 0.02351249940693378f };
* float u3[] = { 0.002072920091450214f, 0.05587499961256981f, 0.02386249974370003f };
* float v1[] = { 0.002277000108733773f, 0.05533599853515625f, 0.02386249974370003f };
* float v2[] = { 0.002277000108733773f, 0.05552500113844872f, 0.02409409917891026f };
* if (tri_tri_intersect(u1, u2, u3, v1, v2, v3))
*		std::cout << 0 << " <--> " << 1 << std::endl;
* if (tri_tri_intersect(v1, v2, v3, u1, u2, u3))
