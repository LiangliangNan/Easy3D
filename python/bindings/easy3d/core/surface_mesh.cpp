...
// easy3d::SurfaceMesh::VertexProperty file:easy3d/core/surface_mesh.h line:184
struct PyCallBack_easy3d_SurfaceMesh_VertexProperty_int_t : public easy3d::SurfaceMesh::VertexProperty<int> {
    using easy3d::SurfaceMesh::VertexProperty<int>::VertexProperty;

    int & operator[](size_t a0) override {
        pybind11::gil_scoped_acquire gil;
        pybind11::function overload = pybind11::get_overload(static_cast<const easy3d::SurfaceMesh::VertexProperty<int> *>(this), "__getitem__");
        if (overload) {
            auto o = overload.operator()<pybind11::return_value_policy::reference>(a0);
...
// easy3d::SurfaceMesh::FaceProperty file:easy3d/core/surface_mesh.h line:256
struct PyCallBack_easy3d_SurfaceMesh_FaceProperty_float_t : public easy3d::SurfaceMesh::FaceProperty<float> {
    using easy3d::SurfaceMesh::FaceProperty<float>::FaceProperty;

    float & operator[](size_t a0) override {
        pybind11::gil_scoped_acquire gil;
        pybind11::function overload = pybind11::get_overload(static_cast<const easy3d::SurfaceMesh::FaceProperty<float> *>(this), "__getitem__");
        if (overload) {
            auto o = overload.operator()<pybind11::return_value_policy::reference>(a0);
            if (pybind11::detail::cast_is_temporary_value_reference<float &>::value) {
                static pybind11::detail::override_caster_t<float &> caster;
...
// easy3d::SurfaceMesh::FaceProperty file:easy3d/core/surface_mesh.h line:256
struct PyCallBack_easy3d_SurfaceMesh_FaceProperty_int_t : public easy3d::SurfaceMesh::FaceProperty<int> {
    using easy3d::SurfaceMesh::FaceProperty<int>::FaceProperty;

    int & operator[](size_t a0) override {
        pybind11::gil_scoped_acquire gil;
        pybind11::function overload = pybind11::get_overload(static_cast<const easy3d::SurfaceMesh::FaceProperty<int> *>(this), "__getitem__");
        if (overload) {
            auto o = overload.operator()<pybind11::return_value_policy::reference>(a0);
            if (pybind11::detail::cast_is_temporary_value_reference<int &>::value) {
                static pybind11::detail::override_caster_t<int &> caster;
...
// Converts Python input (either a list of lists, a 1D NumPy array of Python objects, or a 1D NumPy array of unsigned
// integers or integers) to a `std::vector<std::vector<unsigned int>>`.
// The "input" represents the vertex indices of the faces in a general polygonal mesh. Each element in the input corresponds
// to a face in the mesh. For triangle meshes, the input can also be a flat list of unsigned integers, where every group
// of three integers forms a triangular face.
// Supported input formats:
// 1. Python list of lists (each inner list contains vertex indices for a face).
// 2. Python flat list of unsigned/signed integers (for triangle meshes, must have a size divisible by 3).
// 3. 1D NumPy array of Python objects (dtype=object), where each element is a list of vertex indices for a face.
// 4. 1D NumPy array of unsigned integers (dtype=unsigned int) or signed integers (dtype=int), where every consecutive
//    three integers form a triangular face.
// Throws:
// - `std::runtime_error` if the input is invalid or does not conform to the expected formats.
std::vector<std::vector<unsigned int>> convert(const pybind11::object& input) {
    std::vector<std::vector<unsigned int>> result;

    // Case 1: Input is a Python list
    if (pybind11::isinstance<pybind11::list>(input) || pybind11::isinstance<pybind11::tuple>(input)) {
        ...
        // Sub-case 1.2: Flat list of unsigned/signed integers for triangle meshes
            ...
            if (!temp.empty()) {
                throw std::runtime_error("Expected a flat list of unsigned/signed integers divisible by 3");
            }
        } else {
            throw std::runtime_error("Expected a list of lists or a flat list of unsigned/signed integers divisible by 3");
        }
    }
    // Case 2: Input is a NumPy array
        ...
        // Sub-case 2.1: 1D NumPy array of Python objects (dtype=object)
        if (arr.ndim() == 1) {
            ...
            // Sub-case 2.2: 1D NumPy array of unsigned/signed integers
                ...
                // Ensure the number of elements is divisible by 3
                if (!temp.empty()) {
                    throw std::runtime_error("Expected a 1D NumPy array of unsigned integers divisible by 3");
                }
            }
            // Sub-case 2.3: 1D NumPy array of unsigned integers (dtype=int)
                ...
                // Ensure the number of elements is divisible by 3
                if (!temp.empty()) {
                    throw std::runtime_error("Expected a 1D NumPy array of signed integers divisible by 3");
                }
            }
            else {
                throw std::runtime_error("Expected a 1D NumPy array of objects or unsigned/signed integers");
            }
        } else {
            throw std::runtime_error("Expected a 1D NumPy array");
        }
    } else {
        throw std::runtime_error("Expected a Python list or 1D NumPy array");
    }
...
void bind_easy3d_core_surface_mesh(pybind11::module_& m)
{
	{ // easy3d::SurfaceMesh file:easy3d/core/surface_mesh.h line:51
        ...
        // Initialize a triangle SurfaceMesh from vertices and vertex indices of the triangle faces.
        cl.def(pybind11::init([](const std::vector<easy3d::vec3> &points, const std::vector<unsigned int> &indices) {
                   auto mesh = std::make_shared<easy3d::SurfaceMesh>();
                   for (const auto &point: points)
                       mesh->add_vertex(point);
                   for (size_t i = 0; i < indices.size(); i += 3)
                       mesh->add_triangle(easy3d::SurfaceMesh::Vertex(indices[i]),
                                          easy3d::SurfaceMesh::Vertex(indices[i + 1]),
                                          easy3d::SurfaceMesh::Vertex(indices[i + 2])
                       );
                   return mesh;
               }),
               R"doc(
                 Initialize a triangle SurfaceMesh from vertices and vertex indices of the triangle faces.
                 - The "vertices" is an array of 3D points providing the vertex positions.
                 - The "indices" represents the vertex indices (0-based) of the triangle faces of the mesh, in which
                   each three consecutive indices forms a triangular face.
                 )doc",
               pybind11::arg("points"), pybind11::arg("indices")
        );
        ...
        cl.def(pybind11::init([](pybind11::object points, pybind11::object &indices) {
           ...
           R"doc(
                Initialize a SurfaceMesh (not necessarily a triangle mesh) from vertices and vertex indices of faces.
                - The "points" is a set of 3D points providing the vertex positions. It must be a list of tuples or a
                  NumPy array with shape (n, 3).
                - The "indices" represents the vertex indices (0-based) of the faces in a general polygonal mesh.
                  Supported input formats:
                    - Python list of lists (each inner list contains vertex indices for a face).
                    - Python flat list of unsigned/signed integers divisible by 3 (only for triangle meshes). Every
                      consecutive three integers forms a triangular face.
                    - 1D NumPy array of Python objects (dtype=object), where each element is a list of vertex indices for a face.
                    - 1D NumPy array of unsigned integers (dtype=unsigned int) or signed integers (dtype=int) divisible
                      by 3 (only for triangle meshes). Every consecutive three integers forms a triangular face.
                )doc",
               pybind11::arg("points"), pybind11::arg("indices")
        );
...
//                       return pybind11::cast(mesh.add_vertex_property<std::string>(name));
        ...
        // Add a generic method for adding face properties with a dtype argument
        cl.def("add_face_property",
               [](easy3d::SurfaceMesh &mesh, const std::string &name, pybind11::object dtype) -> pybind11::object {
                   if (dtype.is(pybind11::float_().get_type())) {
                       ...
                       return pybind11::cast(mesh.add_face_property<easy3d::vec3>(name));
//                   } else if (dtype.is(pybind11::str().get_type())) {
...
//                       return pybind11::cast(mesh.get_vertex_property<std::string>(name));
        ...
        // Add a generic method for getting face properties with a dtype argument
        cl.def("get_face_property",
               [](easy3d::SurfaceMesh &mesh, const std::string &name, pybind11::object dtype) -> pybind11::object {
                   if (dtype.is(pybind11::float_().get_type())) {
                       ...
                       return pybind11::cast(mesh.get_face_property<easy3d::vec3>(name));
//                   } else if (dtype.is(pybind11::str().get_type())) {
//                       return pybind11::cast(mesh.get_face_property<std::string>(name));
		...
		{ // easy3d::SurfaceMesh::VertexProperty file:easy3d/core/surface_mesh.h line:184
            ...
            cl.def("__getitem__", [](easy3d::SurfaceMesh::VertexProperty<bool> &prop, easy3d::SurfaceMesh::Vertex v) -> bool { return prop[v]; }, pybind11::arg("v"), pybind11::return_value_policy::reference_internal);
            ...
            cl.def("__setitem__", [](easy3d::SurfaceMesh::VertexProperty<bool> &prop, const easy3d::SurfaceMesh::Vertex &v, bool value) { prop[v] = value; });
		...
		{ // easy3d::SurfaceMesh::VertexProperty file:easy3d/core/surface_mesh.h line:184
            ...
            cl.def("__setitem__", [](easy3d::SurfaceMesh::VertexProperty<class easy3d::Vec<3, float> >& prop, const easy3d::SurfaceMesh::Vertex& v, const class easy3d::Vec<3, float>& value) { prop[v] = value; });
		...
		{ // easy3d::SurfaceMesh::VertexProperty file:easy3d/core/surface_mesh.h line:184
            ...
            cl.def("__setitem__", [](easy3d::SurfaceMesh::VertexProperty<float>& prop, const easy3d::SurfaceMesh::Vertex& v, float value) { prop[v] = value; });
        ...
        { // easy3d::SurfaceMesh::VertexProperty file:easy3d/core/surface_mesh.h line:184
			auto & enclosing_class = cl;
			pybind11::class_<easy3d::SurfaceMesh::VertexProperty<int>, std::shared_ptr<easy3d::SurfaceMesh::VertexProperty<int>>, PyCallBack_easy3d_SurfaceMesh_VertexProperty_int_t, easy3d::Property<int>> cl(enclosing_class, "VertexProperty_int_t", "");
			cl.def( pybind11::init( [](){ return new easy3d::SurfaceMesh::VertexProperty<int>(); }, [](){ return new PyCallBack_easy3d_SurfaceMesh_VertexProperty_int_t(); } ) );
			cl.def( pybind11::init<class easy3d::Property<int>>(), pybind11::arg("p") );

			cl.def("__getitem__", (int & (easy3d::SurfaceMesh::VertexProperty<int>::*)(struct easy3d::SurfaceMesh::Vertex)) &easy3d::SurfaceMesh::VertexProperty<int>::operator[], "C++: easy3d::SurfaceMesh::VertexProperty<int>::operator[](struct easy3d::SurfaceMesh::Vertex) --> int &", pybind11::return_value_policy::automatic, pybind11::arg("v"));
            ...
            cl.def("__setitem__", [](easy3d::SurfaceMesh::VertexProperty<int>& prop, const easy3d::SurfaceMesh::Vertex& v, int value) { prop[v] = value; });

            cl.def("assign", (class easy3d::SurfaceMesh::VertexProperty<int> & (easy3d::SurfaceMesh::VertexProperty<int>::*)(const class easy3d::SurfaceMesh::VertexProperty<int> &)) &easy3d::SurfaceMesh::VertexProperty<int>::operator=, "C++: easy3d::SurfaceMesh::VertexProperty<int>::operator=(const class easy3d::SurfaceMesh::VertexProperty<int> &) --> class easy3d::SurfaceMesh::VertexProperty<int> &", pybind11::return_value_policy::automatic, pybind11::arg(""));
		...
		{ // easy3d::SurfaceMesh::FaceProperty file:easy3d/core/surface_mesh.h line:256
            ...
            // Define the FaceProperty<bool> specialization
            cl.def("__getitem__", [](easy3d::SurfaceMesh::FaceProperty<bool> &prop, easy3d::SurfaceMesh::Face f) -> bool { return prop[f]; }, pybind11::arg("f"), pybind11::return_value_policy::reference_internal);
            // Define the Property<bool> specialization
            cl.def("__getitem__", [](easy3d::Property<bool> &prop, size_t i) -> bool { return prop[i]; }, pybind11::arg("i"), pybind11::return_value_policy::reference_internal);
            cl.def("__setitem__", [](easy3d::SurfaceMesh::FaceProperty<bool> &prop, const easy3d::SurfaceMesh::Face &f, bool value) { prop[f] = value; });
		...
		{ // easy3d::SurfaceMesh::FaceProperty file:easy3d/core/surface_mesh.h line:256
            ...
            cl.def("__getitem__", (class easy3d::Vec<3, float> & (easy3d::Property<easy3d::Vec<3, float>>::*)(size_t)) &easy3d::Property<easy3d::Vec<3, float>>::operator[], "C++: easy3d::Property<easy3d::Vec<3, float>>::operator[](size_t) --> class easy3d::Vec<3, float> &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
            cl.def("__setitem__", [](easy3d::SurfaceMesh::FaceProperty<class easy3d::Vec<3, float> >& prop, const easy3d::SurfaceMesh::Face& f, const class easy3d::Vec<3, float>& value) { prop[f] = value; });
        ...
        { // easy3d::SurfaceMesh::FaceProperty file:easy3d/core/surface_mesh.h line:256
            auto & enclosing_class = cl;
            pybind11::class_<easy3d::SurfaceMesh::FaceProperty<float>, std::shared_ptr<easy3d::SurfaceMesh::FaceProperty<float>>, PyCallBack_easy3d_SurfaceMesh_FaceProperty_float_t, easy3d::Property<float>> cl(enclosing_class, "FaceProperty_float_t", "");
            cl.def( pybind11::init( [](){ return new easy3d::SurfaceMesh::FaceProperty<float>(); }, [](){ return new PyCallBack_easy3d_SurfaceMesh_FaceProperty_float_t(); } ) );
            cl.def( pybind11::init<class easy3d::Property<float>>(), pybind11::arg("p") );

            cl.def("__getitem__", (float & (easy3d::SurfaceMesh::FaceProperty<float>::*)(struct easy3d::SurfaceMesh::Face)) &easy3d::SurfaceMesh::FaceProperty<float>::operator[], "C++: easy3d::SurfaceMesh::FaceProperty<float>::operator[](struct easy3d::SurfaceMesh::Face) --> float &", pybind11::return_value_policy::automatic, pybind11::arg("f"));
            cl.def("__getitem__", (float & (easy3d::Property<float>::*)(size_t)) &easy3d::Property<float>::operator[], "C++: easy3d::Property<float>::operator[](size_t) --> float &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
            cl.def("__setitem__", [](easy3d::SurfaceMesh::FaceProperty<float>& prop, const easy3d::SurfaceMesh::Face& f, float value) { prop[f] = value; });

            cl.def("assign", (class easy3d::SurfaceMesh::FaceProperty<float> & (easy3d::SurfaceMesh::FaceProperty<float>::*)(const class easy3d::SurfaceMesh::FaceProperty<float> &)) &easy3d::SurfaceMesh::FaceProperty<float>::operator=, "C++: easy3d::SurfaceMesh::FaceProperty<float>::operator=(const class easy3d::SurfaceMesh::FaceProperty<float> &) --> class easy3d::SurfaceMesh::FaceProperty<float> &", pybind11::return_value_policy::automatic, pybind11::arg(""));
            cl.def("reset", (void (easy3d::Property<float>::*)()) &easy3d::Property<float>::reset, "C++: easy3d::Property<float>::reset() --> void");
            cl.def("data", (const float * (easy3d::Property<float>::*)() const) &easy3d::Property<float>::data, "C++: easy3d::Property<float>::data() const --> const float *", pybind11::return_value_policy::automatic);
            cl.def("vector", (class std::vector<float> & (easy3d::Property<float>::*)()) &easy3d::Property<float>::vector, "C++: easy3d::Property<float>::vector() --> class std::vector<float> &", pybind11::return_value_policy::automatic);
            cl.def("array", (class easy3d::PropertyArray<float> & (easy3d::Property<float>::*)()) &easy3d::Property<float>::array, "C++: easy3d::Property<float>::array() --> class easy3d::PropertyArray<float> &", pybind11::return_value_policy::automatic);
        ...
        { // easy3d::SurfaceMesh::FaceProperty file:easy3d/core/surface_mesh.h line:256
            auto & enclosing_class = cl;
            pybind11::class_<easy3d::SurfaceMesh::FaceProperty<int>, std::shared_ptr<easy3d::SurfaceMesh::FaceProperty<int>>, PyCallBack_easy3d_SurfaceMesh_FaceProperty_int_t, easy3d::Property<int>> cl(enclosing_class, "FaceProperty_int_t", "");
            cl.def( pybind11::init( [](){ return new easy3d::SurfaceMesh::FaceProperty<int>(); }, [](){ return new PyCallBack_easy3d_SurfaceMesh_FaceProperty_int_t(); } ) );
            cl.def( pybind11::init<class easy3d::Property<int>>(), pybind11::arg("p") );

            cl.def("__getitem__", (int & (easy3d::SurfaceMesh::FaceProperty<int>::*)(struct easy3d::SurfaceMesh::Face)) &easy3d::SurfaceMesh::FaceProperty<int>::operator[], "C++: easy3d::SurfaceMesh::FaceProperty<int>::operator[](struct easy3d::SurfaceMesh::Face) --> int &", pybind11::return_value_policy::automatic, pybind11::arg("f"));
            cl.def("__getitem__", (int & (easy3d::Property<int>::*)(size_t)) &easy3d::Property<int>::operator[], "C++: easy3d::Property<int>::operator[](size_t) --> int &", pybind11::return_value_policy::automatic, pybind11::arg("i"));
            cl.def("__setitem__", [](easy3d::SurfaceMesh::FaceProperty<int>& prop, const easy3d::SurfaceMesh::Face& f, int value) { prop[f] = value; });

            cl.def("assign", (class easy3d::SurfaceMesh::FaceProperty<int> & (easy3d::SurfaceMesh::FaceProperty<int>::*)(const class easy3d::SurfaceMesh::FaceProperty<int> &)) &easy3d::SurfaceMesh::FaceProperty<int>::operator=, "C++: easy3d::SurfaceMesh::FaceProperty<int>::operator=(const class easy3d::SurfaceMesh::FaceProperty<int> &) --> class easy3d::SurfaceMesh::FaceProperty<int> &", pybind11::return_value_policy::automatic, pybind11::arg(""));
            cl.def("reset", (void (easy3d::Property<int>::*)()) &easy3d::Property<int>::reset, "C++: easy3d::Property<int>::reset() --> void");
            cl.def("data", (const int * (easy3d::Property<int>::*)() const) &easy3d::Property<int>::data, "C++: easy3d::Property<int>::data() const --> const int *", pybind11::return_value_policy::automatic);
            cl.def("vector", (class std::vector<int> & (easy3d::Property<int>::*)()) &easy3d::Property<int>::vector, "C++: easy3d::Property<int>::vector() --> class std::vector<int> &", pybind11::return_value_policy::automatic);
            cl.def("array", (class easy3d::PropertyArray<int> & (easy3d::Property<int>::*)()) &easy3d::Property<int>::array, "C++: easy3d::Property<int>::array() --> class easy3d::PropertyArray<int> &", pybind11::return_value_policy::automatic);
