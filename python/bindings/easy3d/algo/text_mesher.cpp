...
void bind_easy3d_algo_text_mesher(pybind11::module_& m)
{
	{ // easy3d::TextMesher file:easy3d/algo/text_mesher.h line:42
		...
		cl.def("generate", [](easy3d::TextMesher &o, const std::string & a0, float const & a1, float const & a2, int const & a3, float const & a4) -> easy3d::SurfaceMesh * { return o.generate(a0, a1, a2, a3, a4); }, "", pybind11::return_value_policy::automatic, pybind11::arg("text"), pybind11::arg("x"), pybind11::arg("y"), pybind11::arg("font_size"), pybind11::arg("height"));
		cl.def("generate", (class easy3d::SurfaceMesh * (easy3d::TextMesher::*)(const std::string &, float, float, int, float, bool)) &easy3d::TextMesher::generate, "Generate a 3D surface mesh of a text.\n \n\n The input text.\n \n\n The x-coordinate of the starting position.\n \n\n The y-coordinate of the starting position.\n \n\n The size of the font.\n \n\n The height (in the Z direction) of the 3D model.\n \n\n If true, the final mesh will be free of intersections between characters.\n \n\n The generated triangular surface mesh.\n\nC++: easy3d::TextMesher::generate(const std::string &, float, float, int, float, bool) --> class easy3d::SurfaceMesh *", pybind11::return_value_policy::automatic, pybind11::arg("text"), pybind11::arg("x"), pybind11::arg("y"), pybind11::arg("font_size"), pybind11::arg("height"), pybind11::arg("collision_free"));
		cl.def("generate", [](easy3d::TextMesher &o, class easy3d::SurfaceMesh * a0, const std::string & a1, float const & a2, float const & a3, int const & a4, float const & a5) -> bool { return o.generate(a0, a1, a2, a3, a4, a5); }, "", pybind11::arg("mesh"), pybind11::arg("text"), pybind11::arg("x"), pybind11::arg("y"), pybind11::arg("font_size"), pybind11::arg("height"));
		cl.def("generate", (bool (easy3d::TextMesher::*)(class easy3d::SurfaceMesh *, const std::string &, float, float, int, float, bool)) &easy3d::TextMesher::generate, "Generate 3D surface representation of a text and append the surface to an existing mesh.\n \n\n The input text.\n \n\n The x-coordinate of the starting position.\n \n\n The y-coordinate of the starting position.\n \n\n The size of the font.\n \n\n The height (in the Z direction) of the 3D model.\n \n\n If true, the final mesh will be free of intersections between characters.\n \n\n  on success and  on failure.\n\nC++: easy3d::TextMesher::generate(class easy3d::SurfaceMesh *, const std::string &, float, float, int, float, bool) --> bool", pybind11::arg("mesh"), pybind11::arg("text"), pybind11::arg("x"), pybind11::arg("y"), pybind11::arg("font_size"), pybind11::arg("height"), pybind11::arg("collision_free"));
