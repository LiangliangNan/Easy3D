...
int main(int argc, char** argv) {
    ...
    try {
        ...
        // Drawables are typically created from rendering a 3D model
        // (e.g., point clouds, meshes, graphs) and the 3D model are
        // usually loaded from a file or generated by an algorithm.
        // Easy3D also allows to visualize drawable without a model.
