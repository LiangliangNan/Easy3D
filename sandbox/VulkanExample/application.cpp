...
void Application::createLogicalDevice() {
    ...
    vkGetDeviceQueue(logical_device_, indices.graphicsFamily.value(), 0, &graphicsQueue);
    vkGetDeviceQueue(logical_device_, indices.presentFamily.value(), 0, &presentQueue);
}
